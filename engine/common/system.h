...
#define MSGBOX( x )		SDL_ShowSimpleMessageBox( SDL_MESSAGEBOX_ERROR, "Half-Life Engine Error", x, NULL )
...
#define MSGBOX( x ) 	Android_MessageBox("Half-Life Engine Error", x )
#define MSGBOX2( x )	Android_MessageBox("Host Error", x )
#define MSGBOX3( x )	Android_MessageBox("Host Recursive Error", x )
#elif defined _WIN32
#define MSGBOX( x ) 	MessageBox( NULL, x, "Half-Life Engine Error", MB_OK|MB_SETFOREGROUND|MB_ICONSTOP )
...
#else
#define BORDER1 "======================================\n"
#define MSGBOX( x )		fprintf(stderr, BORDER1 "Half-Life Engine Error: %s\n" BORDER1,x)
